...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Xh(){return new qe({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$l(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function qh(){return new qe({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$l(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function $l(){return`
	...
	`}function xm(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){let c=o.mapping,l=c===Da||c===Ua,h=c===Ei||c===Ti;if(l||h){let d=t.get(o),f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new vo(i)),d=l?e.fromEquirectangular(o,d):e.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),d.texture;if(d!==void 0)return d.texture;{let p=o.image;return l&&p&&p.height>0||h&&p&&s(p)?(e===null&&(e=new vo(i)),d=l?e.fromEquirectangular(o):e.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function s(o){let c=0,l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){let c=o.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function ym(i){let t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){let s=e(n);return s===null&&rs("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function vm(i,t,e,n){let s={},r=new WeakMap;function a(d){let f=d.target;f.index!==null&&t.remove(f.index);for(let g in f.attributes)t.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete s[f.id];let p=r.get(f);p&&(t.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(d,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,e.memory.geometries++),f}function c(d){let f=d.attributes;for(let p in f)t.update(f[p],i.ARRAY_BUFFER)}function l(d){let f=[],p=d.index,g=d.attributes.position,y=0;if(p!==null){let w=p.array;y=p.version;for(let E=0,S=w.length;E<S;E+=3){let C=w[E+0],R=w[E+1],L=w[E+2];f.push(C,R,R,L,L,C)}}else if(g!==void 0){let w=g.array;y=g.version;for(let E=0,S=w.length/3-1;E<S;E+=3){let C=E+0,R=E+1,L=E+2;f.push(C,R,R,L,L,C)}}else return;let m=new(Il(f)?Gs:Vs)(f,1);m.version=y;let u=r.get(d);u&&t.remove(u),r.set(d,m)}function h(d){let f=r.get(d);if(f){let p=d.index;p!==null&&f.version<p.version&&l(d)}else l(d);return r.get(d)}return{get:o,update:c,getWireframeAttribute:h}}function Mm(i,t,e){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,p){i.drawElements(n,p,r,f*a),e.update(p,n,1)}function l(f,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,f*a,g),e.update(p,n,g))}function h(f,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,g);let m=0;for(let u=0;u<g;u++)m+=p[u];e.update(m,n,1)}function d(f,p,g,y){if(g===0)return;let m=t.get("WEBGL_multi_draw");if(m===null)for(let u=0;u<f.length;u++)l(f[u]/a,p[u],y[u]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,y,0,g);let u=0;for(let w=0;w<g;w++)u+=p[w]*y[w];e.update(u,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function Sm(i){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(r/3);break;case i.LINES:e.lines+=o*(r/2);break;case i.LINE_STRIP:e.lines+=o*(r-1);break;case i.LINE_LOOP:e.lines+=o*r;break;case i.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function bm(i,t,e){let n=new WeakMap,s=new Zt;function r(a,o,c){let l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=h!==void 0?h.length:0,f=n.get(o);if(f===void 0||f.count!==d){let M=function(){L.dispose(),n.delete(o),o.removeEventListener("dispose",M)};f!==void 0&&f.texture.dispose();let p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,y=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],w=o.morphAttributes.color||[],E=0;p===!0&&(E=1),g===!0&&(E=2),y===!0&&(E=3);let S=o.attributes.position.count*E,C=1;S>t.maxTextureSize&&(C=Math.ceil(S/t.maxTextureSize),S=t.maxTextureSize);let R=new Float32Array(S*C*4*d),L=new Hs(R,S,C,d);L.type=Mn,L.needsUpdate=!0;let F=E*4;for(let v=0;v<d;v++){let P=m[v],z=u[v],V=w[v],X=S*C*4*v;for(let Z=0;Z<P.count;Z++){let W=Z*F;p===!0&&(s.fromBufferAttribute(P,Z),R[X+W+0]=s.x,R[X+W+1]=s.y,R[X+W+2]=s.z,R[X+W+3]=0),g===!0&&(s.fromBufferAttribute(z,Z),R[X+W+4]=s.x,R[X+W+5]=s.y,R[X+W+6]=s.z,R[X+W+7]=0),y===!0&&(s.fromBufferAttribute(V,Z),R[X+W+8]=s.x,R[X+W+9]=s.y,R[X+W+10]=s.z,R[X+W+11]=V.itemSize===4?s.w:1)}}f={count:d,texture:L,size:new St(S,C)},n.set(o,f),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let p=0;for(let y=0;y<l.length;y++)p+=l[y];let g=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Em(i,t,e,n){let s=new WeakMap;function r(c){let l=n.render.frame,h=c.geometry,d=t.get(c,h);if(s.get(d)!==l&&(t.update(d),s.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return d}function a(){s=new WeakMap}function o(c){let l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}var uu=new Fe,Yh=new Js(1,1),du=new Hs,fu=new ra,pu=new Xs,Zh=[],$h=[],Jh=new Float32Array(16),Kh=new Float32Array(9),jh=new Float32Array(4);function bs(i,t,e){let n=i[0];if(n<=0||n>0)return i;let s=t*e,r=Zh[s];if(r===void 0&&(r=new Float32Array(s),Zh[s]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(r,o)}return r}function ve(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Me(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function So(i,t){let e=$h[t];e===void 0&&(e=new Int32Array(t),$h[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Tm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function wm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ve(e,t))return;i.uniform2fv(this.addr,t),Me(e,t)}}function Am(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ve(e,t))return;i.uniform3fv(this.addr,t),Me(e,t)}}function Rm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ve(e,t))return;i.uniform4fv(this.addr,t),Me(e,t)}}function Cm(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(ve(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Me(e,t)}else{if(ve(e,n))return;jh.set(n),i.uniformMatrix2fv(this.addr,!1,jh),Me(e,n)}}function Im(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(ve(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Me(e,t)}else{if(ve(e,n))return;Kh.set(n),i.uniformMatrix3fv(this.addr,!1,Kh),Me(e,n)}}function Pm(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(ve(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Me(e,t)}else{if(ve(e,n))return;Jh.set(n),i.uniformMatrix4fv(this.addr,!1,Jh),Me(e,n)}}function Lm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Dm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ve(e,t))return;i.uniform2iv(this.addr,t),Me(e,t)}}function Um(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ve(e,t))return;i.uniform3iv(this.addr,t),Me(e,t)}}function Nm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ve(e,t))return;i.uniform4iv(this.addr,t),Me(e,t)}}function Fm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Om(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ve(e,t))return;i.uniform2uiv(this.addr,t),Me(e,t)}}function Bm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ve(e,t))return;i.uniform3uiv(this.addr,t),Me(e,t)}}function zm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ve(e,t))return;i.uniform4uiv(this.addr,t),Me(e,t)}}function km(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Yh.compareFunction=Al,r=Yh):r=uu,e.setTexture2D(t||r,s)}function Hm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||fu,s)}function Vm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||pu,s)}function Gm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||du,s)}function Wm(i){switch(i){case 5126:return Tm;case 35664:return wm;case 35665:return Am;case 35666:return Rm;case 35674:return Cm;case 35675:return Im;case 35676:return Pm;case 5124:case 35670:return Lm;case 35667:case 35671:return Dm;case 35668:case 35672:return Um;case 35669:case 35673:return Nm;case 5125:return Fm;case 36294:return Om;case 36295:return Bm;case 36296:return zm;case 35678:case 36198:case 36298:case 36306:case 35682:return km;case 35679:case 36299:case 36307:return Hm;case 35680:case 36300:case 36308:case 36293:return Vm;case 36289:case 36303:case 36311:case 36292:return Gm}}function Xm(i,t){i.uniform1fv(this.addr,t)}function qm(i,t){let e=bs(t,this.size,2);i.uniform2fv(this.addr,e)}function Ym(i,t){let e=bs(t,this.size,3);i.uniform3fv(this.addr,e)}function Zm(i,t){let e=bs(t,this.size,4);i.uniform4fv(this.addr,e)}function $m(i,t){let e=bs(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Jm(i,t){let e=bs(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Km(i,t){let e=bs(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function jm(i,t){i.uniform1iv(this.addr,t)}function Qm(i,t){i.uniform2iv(this.addr,t)}function tg(i,t){i.uniform3iv(this.addr,t)}function eg(i,t){i.uniform4iv(this.addr,t)}function ng(i,t){i.uniform1uiv(this.addr,t)}function ig(i,t){i.uniform2uiv(this.addr,t)}function sg(i,t){i.uniform3uiv(this.addr,t)}function rg(i,t){i.uniform4uiv(this.addr,t)}function ag(i,t,e){let n=this.cache,s=t.length,r=So(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),Me(n,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||uu,r[a])}function og(i,t,e){let n=this.cache,s=t.length,r=So(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),Me(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||fu,r[a])}function lg(i,t,e){let n=this.cache,s=t.length,r=So(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),Me(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||pu,r[a])}function cg(i,t,e){let n=this.cache,s=t.length,r=So(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),Me(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||du,r[a])}function hg(i){switch(i){case 5126:return Xm;case 35664:return qm;case 35665:return Ym;case 35666:return Zm;case 35674:return $m;case 35675:return Jm;case 35676:return Km;case 5124:case 35670:return jm;case 35667:case 35671:return Qm;case 35668:case 35672:return tg;case 35669:case 35673:return eg;case 5125:return ng;case 36294:return ig;case 36295:return sg;case 36296:return rg;case 35678:case 36198:case 36298:case 36306:case 35682:return ag;case 35679:case 36299:case 36307:return og;case 35680:case 36300:case 36308:case 36293:return lg;case 36289:case 36303:case 36311:case 36292:return cg}}var Hl=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Wm(e.type)}},Vl=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=hg(e.type)}},Gl=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(t,e[o.id],n)}}},kl=/(\w+)(\])?(\[|\.)?/g;function Qh(i,t){i.seq.push(t),i.map[t.id]=t}function ug(i,t,e){let n=i.name,s=n.length;for(kl.lastIndex=0;;){let r=kl.exec(n),a=kl.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Qh(e,l===void 0?new Hl(o,i,t):new Vl(o,i,t));break}else{let d=e.map[o];d===void 0&&(d=new Gl(o),Qh(e,d)),e=d}}}var Ss=class{constructor(t,e){this.seq=[],this.map={};let n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);ug(r,a,this)}}setValue(t,e,n,s){let r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){let s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,a=e.length;r!==a;++r){let o=e[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,s)}}static seqWithValue(t,e){let n=[];for(let s=0,r=t.length;s!==r;++s){let a=t[s];a.id in e&&n.push(a)}return n}};function tu(i,t,e){let n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}var dg=37297,fg=0;function pg(i,t){let e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}var eu=new Ut;function mg(i){Gt._getMatrix(eu,Gt.workingColorSpace,i);let t=`mat3( ${eu.elements.map(e=>e.toFixed(4))} )`;switch(Gt.getTransfer(i)){case zs:return[t,"LinearTransferOETF"];case $t:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function nu(i,t,e){let n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return e.toUpperCase()+`
...
`)}function _g(i,t){let e;switch(t){case xh:e="Linear";break;case yh:e="Reinhard";break;case vh:e="Cineon";break;case La:e="ACESFilmic";break;case Sh:e="AgX";break;case bh:e="Neutral";break;case Mh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var yo=new A;function xg(){Gt.getLuminanceCoefficients(yo);let i=yo.x.toFixed(4),t=yo.y.toFixed(4),e=yo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Mg(i,t){let e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(t,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function ur(i){return i!==""}function iu(i,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function su(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var Sg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wl(i){return i.replace(Sg,Eg)}var bg=new Map;function Eg(i,t){let e=Bt[t];if(e===void 0){let n=bg.get(t);if(n!==void 0)e=Bt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Wl(e)}var Tg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ru(i){return i.replace(Tg,wg)}function wg(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function au(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Ag(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Kc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===vn&&(t="SHADOWMAP_TYPE_VSM"),t}function Rg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ei:case Ti:t="ENVMAP_TYPE_CUBE";break;case rr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Cg(i){let t="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===Ti&&(t="ENVMAP_MODE_REFRACTION"),t}function Ig(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case gl:t="ENVMAP_BLENDING_MULTIPLY";break;case gh:t="ENVMAP_BLENDING_MIX";break;case _h:t="ENVMAP_BLENDING_ADD";break}return t}function Pg(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Lg(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=Ag(e),l=Rg(e),h=Cg(e),d=Ig(e),f=Pg(e),p=yg(e),g=vg(r),y=s.createProgram(),m,u,w=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(ur).join(`
`),u=[au(e),"#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,g,e.useFog&&e.fog?"#define USE_FOG":"",e.useFog&&e.fogExp2?"#define FOG_EXP2":"",e.alphaToCoverage?"#define ALPHA_TO_COVERAGE":"",e.map?"#define USE_MAP":"",e.matcap?"#define USE_MATCAP":"",e.envMap?"#define USE_ENVMAP":"",e.envMap?"#define "+l:"",e.envMap?"#define "+h:"",e.envMap?"#define "+d:"",f?"#define CUBEUV_TEXEL_WIDTH "+f.texelWidth:"",f?"#define CUBEUV_TEXEL_HEIGHT "+f.texelHeight:"",f?"#define CUBEUV_MAX_MIP "+f.maxMip+".0":"",e.lightMap?"#define USE_LIGHTMAP":"",e.aoMap?"#define USE_AOMAP":"",e.bumpMap?"#define USE_BUMPMAP":"",e.normalMap?"#define USE_NORMALMAP":"",e.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",e.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",e.emissiveMap?"#define USE_EMISSIVEMAP":"",e.anisotropy?"#define USE_ANISOTROPY":"",e.anisotropyMap?"#define USE_ANISOTROPYMAP":"",e.clearcoat?"#define USE_CLEARCOAT":"",e.clearcoatMap?"#define USE_CLEARCOATMAP":"",e.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",e.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",e.dispersion?"#define USE_DISPERSION":"",e.iridescence?"#define USE_IRIDESCENCE":"",e.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",e.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",e.specularMap?"#define USE_SPECULARMAP":"",e.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",e.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",e.roughnessMap?"#define USE_ROUGHNESSMAP":"",e.metalnessMap?"#define USE_METALNESSMAP":"",e.alphaMap?"#define USE_ALPHAMAP":"",e.alphaTest?"#define USE_ALPHATEST":"",e.alphaHash?"#define USE_ALPHAHASH":"",e.sheen?"#define USE_SHEEN":"",e.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",e.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",e.transmission?"#define USE_TRANSMISSION":"",e.transmissionMap?"#define USE_TRANSMISSIONMAP":"",e.thicknessMap?"#define USE_THICKNESSMAP":"",e.vertexTangents&&e.flatShading===!1?"#define USE_TANGENT":"",e.vertexColors||e.instancingColor||e.batchingColor?"#define USE_COLOR":"",e.vertexAlphas?"#define USE_COLOR_ALPHA":"",e.vertexUv1s?"#define USE_UV1":"",e.vertexUv2s?"#define USE_UV2":"",e.vertexUv3s?"#define USE_UV3":"",e.pointsUvs?"#define USE_POINTS_UV":"",e.gradientMap?"#define USE_GRADIENTMAP":"",e.flatShading?"#define FLAT_SHADED":"",e.doubleSided?"#define DOUBLE_SIDED":"",e.flipSided?"#define FLIP_SIDED":"",e.shadowMapEnabled?"#define USE_SHADOWMAP":"",e.shadowMapEnabled?"#define "+c:"",e.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",e.numLightProbes>0?"#define USE_LIGHT_PROBES":"",e.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",e.decodeVideoTextureEmissive?"#define DECODE_VIDEO_TEXTURE_EMISSIVE":"",e.logarithmicDepthBuffer?"#define USE_LOGARITHMIC_DEPTH_BUFFER":"",e.reversedDepthBuffer?"#define USE_REVERSED_DEPTH_BUFFER":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",e.toneMapping!==Bn?"#define TONE_MAPPING":"",e.toneMapping!==Bn?Bt.tonemapping_pars_fragment:"",e.toneMapping!==Bn?_g("toneMapping",e.toneMapping):"",e.dithering?"#define DITHERING":"",e.opaque?"#define OPAQUE":"",Bt.colorspace_pars_fragment,gg("linearToOutputTexel",e.outputColorSpace),xg(),e.useDepthPacking?"#define DEPTH_PACKING "+e.depthPacking:"",`
`].filter(ur).join(`
`)),a=Wl(a),a=iu(a,e),a=su(a,e),o=Wl(o),o=iu(o,e),o=su(o,e),a=ru(a),o=ru(o),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+u);let E=w+m+a,S=w+u+o,C=tu(s,s.VERTEX_SHADER,E),R=tu(s,s.FRAGMENT_SHADER,S);s.attachShader(y,C),s.attachShader(y,R),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function L(P){if(i.debug.checkShaderErrors){let z=s.getProgramInfoLog(y)||"",V=s.getShaderInfoLog(C)||"",X=s.getShaderInfoLog(R)||"",Z=z.trim(),W=V.trim(),et=X.trim(),k=!0,rt=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(k=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,C,R);else{let ht=nu(s,C,"vertex"),Et=nu(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
void main() {
  ...
  `;Ro=new qe({transparent:!0,depthTest:!1,depthWrite:!1,toneMapped:!0,uniforms:{uTime:{value:0},uElevation:{value:.2}},vertexShader:r,fragmentShader:a}),_r=new Jt(new vi(34,22),Ro),_r.renderOrder=10,i.add(_r)}function I_(i){i.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(n=>n.dispose())}),i.clear()}function En(i,t){let e=new ye,n=new Jt(new Pe(i,40,24),new ze({color:t}));return e.add(n),e.add(uc(hc("#fff",`#${new Nt(t).getHexString()}`,"rgba(60,100,160,0)"),i*5,.55)),e}function sc(i,t,e,n,s=0){let r=new ye,a=new Jt(new Pe(i,24,14),new dn({color:t,roughness:.85}));return a.position.x=e,r.add(a),gr.push({pivot:r,speed:n,phase:s}),r}function P_(i){let t=$e.system;t?I_(t):(t=new ye,$e.system=t,Hn.add(t)),t.visible=!0,gr=[],t.add(new bi(6582661,.5));let e=Oe[i];if(i==="alpha-centauri"){let s=new ye,r=En(2.2,16767375),a=En(1.65,16758125);r.position.x=-3,a.position.x=4,s.add(r,a),t.add(s),gr.push({pivot:s,speed:.12,phase:0});let o=En(.8,16733499);o.position.set(15,2,-5),t.add(o),t.add(sc(.48,10185808,18,.5,1.2))}else if(i==="sirius"){let s=new ye,r=En(2.7,14478591),a=En(.55,16120831);r.position.x=-2,a.position.x=8,s.add(r,a),t.add(s),gr.push({pivot:s,speed:.18,phase:0})}else if(i==="trappist-1"){t.add(En(1.7,16734267));for(let s=0;s<7;s++){let r=4+s*1.55;t.add(sc(.32+s*.025,8414289+s*525313,r,.8/(s+1),s*.7));let a=Array.from({length:120},(o,c)=>new A(Math.cos(c/120*Math.PI*2)*r,0,Math.sin(c/120*Math.PI*2)*r));t.add(new xi(new fe().setFromPoints(a),new Kn({color:4994868,transparent:!0,opacity:.34})))}}else if(i==="betelgeuse"){let s=En(7.5,16737593);t.add(s);let r=new Jt(new Pe(8.4,32,18),new ze({color:16739125,transparent:!0,opacity:.06,side:we}));t.add(r)}else if(i==="vega"){t.add(En(3.6,14215423));let s=new Jt(new Mi(7,15,96),new ze({color:8894678,transparent:!0,opacity:.12,side:ke,depthWrite:!1}));s.rotation.x=Math.PI/2,t.add(s)}else{let s=En(4.3,16773071);t.add(s);let r=En(.8,16762757);r.position.set(10,2,0),t.add(r),t.add(sc(.45,14272167,15,.16,.5))}let n=new ps(e.color||16777215,160,100);return t.add(n),t}function dc(){for(let i of ri){let t=Ts.get(i.id);t&&(b_(i,pr,t.position),t.holder.position.copy(t.position))}}function L_(i){for(let[t,e]of Object.entries($e))e.visible=t===i}function D_(i,t){if(i==="galaxy")return["MILKY WAY / SCIENTIFIC RECONSTRUCTION","\u94F6\u6CB3\u7CFB \xB7 \u68D2\u65CB\u661F\u7CFB","\u62D6\u52A8\u65CB\u8F6C\uFF0C\u6EDA\u8F6E\u7F29\u653E\uFF1B\u70B9\u51FB\u6807\u8BB0\u6216\u641C\u7D22\u76EE\u6807\u5F00\u59CB\u822A\u884C\u3002"];if(i==="solar")return["SOLAR SYSTEM / J2000 ORBIT MODEL","\u592A\u9633\u7CFB \xB7 \u516B\u5927\u884C\u661F","\u70B9\u51FB\u592A\u9633\u6216\u884C\u661F\u67E5\u770B\u8D44\u6599\uFF1B\u70B9\u51FB\u5730\u7403\u8FDB\u5165\u5730\u6708\u7CFB\u7EDF\u3002"];if(i==="earth")return["EARTH\u2013MOON SYSTEM / TEACHING SCALE","\u5730\u6708\u7CFB \xB7 \u76F8\u4E92\u7ED5\u884C","\u5730\u6708\u8DDD\u79BB\u4E0E\u5929\u4F53\u5927\u5C0F\u91C7\u7528\u4E0D\u540C\u53EF\u89C6\u5316\u6BD4\u4F8B\u3002"];if(i==="blackhole")return["GALACTIC CENTER / RELATIVISTIC VISUALIZATION","\u4EBA\u9A6C\u5EA7 A* \xB7 \u94F6\u6CB3\u7CFB\u4E2D\u5FC3","\u9634\u5F71\u3001\u5149\u5B50\u73AF\u4E0E\u88AB\u5F15\u529B\u900F\u955C\u5F2F\u66F2\u7684\u5438\u79EF\u76D8\u4E3A\u5B9A\u6027\u79D1\u5B66\u53EF\u89C6\u5316\uFF0C\u5E76\u975E\u76F4\u63A5\u7167\u7247\u3002"];let e=Oe[t];return["STELLAR SYSTEM / OBSERVATION MODEL",`${e.name} \xB7 ${e.en}`,"\u7CFB\u5916\u884C\u661F\u6CA1\u6709\u53EF\u9760\u8868\u9762\u5F71\u50CF\uFF0C\u5916\u89C2\u4EC5\u6309\u7269\u7406\u5C5E\u6027\u793A\u610F\u3002"]}function U_(i,t){document.body.className=`mode-${i}${document.body.classList.contains("no-labels")?" no-labels":""}`;let e=D_(i,t);ct("mode-kicker").textContent=e[0],ct("mode-title").textContent=e[1],ct("mode-description").textContent=e[2],ct("render-status").textContent=i==="galaxy"?"GALACTIC MODEL":i==="solar"?"ORBITAL MODEL":i==="earth"?"EARTH\u2013MOON MODEL":i==="blackhole"?"GALACTIC CENTER":"STELLAR MODEL",ct("system-strip").hidden=i!=="solar",xr=0,Tu(),B_(i,t)}function N_(i){return i==="galaxy"?{pos:new A(0,78,60),target:new A,min:16,max:210}:i==="solar"?{pos:new A(0,98,122),target:new A,min:10,max:210}:i==="earth"?{pos:new A(0,10,32),target:new A,min:7,max:52}:i==="blackhole"?{pos:new A(0,6.5,31),target:new A,min:9,max:75}:{pos:new A(0,14,34),target:new A,min:8,max:80}}function F_(i,t,e=900){pn={started:performance.now(),duration:e,startPos:Ze.position.clone(),endPos:i.clone(),startTarget:De.target.clone(),endTarget:t.clone()}}function Di(i,t,e=!1){if(i===le&&i!=="system"&&!e){Co(t),i==="solar"&&lc(t);return}mr=null,pn=null;let n=()=>{le=i,Mr=t,L_(i),i==="system"&&P_(t),i==="solar"&&dc();let r=N_(i);Ze.position.copy(r.pos),De.target.copy(r.target),De.minDistance=r.min,De.maxDistance=r.max,De.update(),U_(i,t),Co(t),bu(),e||setTimeout(()=>ct("travel-screen").classList.remove("active"),280)};if(e){n();return}let s=Oe[t];ct("travel-title").textContent=s.name,ct("travel-distance").textContent=i==="solar"?"\u4ECE\u730E\u6237\u81C2\u8FDB\u5165\u884C\u661F\u5C3A\u5EA6":i==="earth"?"\u4ECE\u884C\u661F\u5C3A\u5EA6\u8FDB\u5165\u5730\u6708\u5C3A\u5EA6":i==="blackhole"?"\u63A5\u8FD1\u94F6\u6CB3\u7CFB\u52A8\u529B\u5B66\u4E2D\u5FC3":"\u6B63\u5728\u5207\u6362\u6052\u661F\u7CFB\u7EDF\u5C3A\u5EA6",ct("travel-screen").classList.add("active"),setTimeout(n,430)}function Fi(i,t=!1){let e=Oe[i];if(e){if(i==="galaxy"){Di("galaxy","galaxy",t);return}if(i==="sagittarius-a"){Di("blackhole",i,t);return}if(i==="solar-system"){Di("solar",i,t);return}if(i==="earth"||i==="moon"){Di("earth",i,t);return}if(e.mode==="system"){Di("system",i,t);return}(i==="sun"||ri.some(n=>n.id===i))&&(le!=="solar"?(Di("solar",i,t),setTimeout(()=>lc(i),t?0:780)):lc(i))}}function lc(i){let t=Ts.get(i);if(!t)return;Mr=i,Co(i),Eu();let e=new A;t.mesh.getWorldPosition(e);let n=i==="sun"?4.2:t.data.visual,s=new A(.85,.45,1).normalize(),r=e.clone().addScaledVector(s,Math.max(8,n*5.2));F_(r,e,800),mr=t.mesh,ac.copy(e)}function O_(){if(!mr||!mr.visible)return;let i=new A;mr.getWorldPosition(i);let t=i.clone().sub(ac);pn||Ze.position.add(t),De.target.copy(i),ac.copy(i)}function Co(i){let t=Oe[i]||Oe.galaxy;Mr=i,ct("object-type").textContent=t.type,ct("object-name").textContent=t.name,ct("object-en").textContent=t.en,ct("object-index").textContent=t.code,ct("object-summary").textContent=t.summary,ct("object-metrics").innerHTML=t.metrics.map(([e,n])=>`<div><dt>${e}</dt><dd>${n}</dd></div>`).join(""),ct("object-facts").innerHTML=t.facts.map(e=>`<div class="fact"><i></i><span>${e}</span></div>`).join(""),ct("scale-note").textContent=t.note||"\u6A21\u578B\u91C7\u7528\u6559\u5B66\u53EF\u89C6\u5316\u6BD4\u4F8B\u3002",ct("source-link").href=t.source,ct("source-link").textContent=`${t.sourceLabel||"\u6743\u5A01\u8D44\u6599"} \u2197`,ct("info-panel").classList.remove("collapsed"),ct("info-reopen").hidden=!0;try{history.replaceState(null,"",`#${i}`)}catch{}bu()}function B_(i,t){let e='<button data-nav="galaxy">\u94F6\u6CB3\u7CFB</button>';i==="galaxy"?e+="<i>\u203A</i><span>\u603B\u89C8</span>":i==="blackhole"?e+="<i>\u203A</i><span>\u94F6\u6CB3\u4E2D\u5FC3</span><i>\u203A</i><span>\u4EBA\u9A6C\u5EA7 A*</span>":i==="solar"?e+='<i>\u203A</i><span>\u730E\u6237\u81C2</span><i>\u203A</i><button data-target="solar-system">\u592A\u9633\u7CFB</button>':i==="earth"?e+='<i>\u203A</i><button data-target="solar-system">\u592A\u9633\u7CFB</button><i>\u203A</i><span>\u5730\u6708\u7CFB</span>':e+=`<i>\u203A</i><span>${Oe[t].name}</span>`,ct("breadcrumb").innerHTML=e}function fc(i="featured"){let t=i==="systems"?jl:xu;ct("target-list").innerHTML=t.map((e,n)=>{let s=Oe[e];return`<button class="target-button ${e===Mr?"active":""}" data-target="${e}"><i style="color:${e==="sagittarius-a"?"#ff9f74":"#60ddff"}"></i><span><b>${s.name}</b><small>${s.en}</small></span><em>${String(n+1).padStart(2,"0")}</em></button>`}).join("")}function bu(){let i=document.querySelector(".catalog-tabs button.active");fc(i?.dataset.catalog||"featured")}function Eu(){let i=["sun",...ri.map(t=>t.id)];ct("system-strip").innerHTML=i.map(t=>`<button data-target="${t}" class="${Mr===t?"active":""}">${Oe[t].name}</button>`).join("")}function z_(i){let t=i.trim().toLowerCase();if(!t){ct("search-results").hidden=!0;return}let e=yu.filter(n=>{let s=Oe[n];return`${s.name} ${s.en} ${s.code}`.toLowerCase().includes(t)}).slice(0,8);ct("search-results").innerHTML=e.map((n,s)=>{let r=Oe[n];return`<button class="search-result ${s===0?"active":""}" data-target="${n}"><span><b>${r.name}</b><small>${r.en}</small></span><em>${r.type.split("\xB7")[0]}</em></button>`}).join(""),ct("search-results").hidden=!e.length}function Tu(){let i=yr[le]||yr.galaxy,t=i[xr%i.length];ct("speed-button").querySelector("b").textContent=t.label}function k_(){if(le==="galaxy")return`J2000 + ${(rc/1e4).toFixed(rc<1e5?1:0)} \u4E07\u5E74`;if(le==="blackhole")return"\u76F8\u5BF9\u65F6\u95F4 \xB7 \u6559\u5B66\u6A21\u62DF";let i=__+pr*864e5,t=new Date(i);return Number.isFinite(t.getTime())?t.toLocaleDateString("zh-CN",{timeZone:"UTC"}):"\u8F68\u9053\u65F6\u95F4\u8D85\u51FA\u8303\u56F4"}function H_(){let i=[];if(le==="galaxy"){let t=Ao?.rotation.y||0;ic.solar.set(Math.cos(t)*26,.15,-Math.sin(t)*26),i.push(["marker-solar",ic.solar],["marker-sgr",ic.sgr])}else if(le==="earth"&&$e.earth?.userData.moon){let t=new A;$e.earth.userData.moon.getWorldPosition(t),i.push(["marker-moon",t])}else return;i.forEach(([t,e])=>{let n=ct(t),s=e.clone().project(Ze),r=s.z>-1&&s.z<1&&Math.abs(s.x)<1.08&&Math.abs(s.y)<1.08;n.style.opacity=r?"1":"0",n.style.pointerEvents=r?"auto":"none",n.style.left=`${(s.x*.5+.5)*innerWidth}px`,n.style.top=`${(-s.y*.5+.5)*innerHeight}px`})}function V_(i){if(!pn)return;let t=Math.min(1,(i-pn.started)/pn.duration),e=1-Math.pow(1-t,3);Ze.position.lerpVectors(pn.startPos,pn.endPos,e),De.target.lerpVectors(pn.startTarget,pn.endTarget,e),t>=1&&(pn=null)}function wu(i){requestAnimationFrame(wu);let t=Math.min(g_.getDelta(),.05),e=(yr[le]||yr.galaxy)[xr]||{};if(kn){if(le==="galaxy"){rc+=t*e.years;let n=t*e.years/23e7*Math.PI*2;Ao.rotation.y+=n,oc.rotation.y+=n*1.7,To.material.rotation-=n*.15}else if(le==="solar"||le==="earth"||le==="system")pr+=t*e.days,le==="solar"&&dc();else if(le==="blackhole"){let n=e.visual||1;Ro.uniforms.uTime.value+=t*n,wo.rotation.y+=t*.08*n}}if(le==="solar"){for(let n of Ts.values())if(n.mesh){let s=Math.max(4,Math.abs(n.data.rotation||24));n.mesh.rotation.y+=t*(kn?1:0)*(12/s),n.mesh.userData.clouds&&(n.mesh.userData.clouds.rotation.y+=t*.018)}}if(le==="earth"&&$e.earth){let n=$e.earth.userData,s=pr/27.321661*Math.PI*2;n.moonHolder.rotation.y=-s,n.earth.rotation.y+=t*.25*(kn?1:0),n.clouds.rotation.y+=t*.035*(kn?1:0),n.moon.rotation.y+=t*.03}if(le==="system"&&kn)for(let n of gr)n.pivot.rotation.y=n.phase+pr*n.speed*.003;V_(i),O_(),De.update(),le==="blackhole"&&_r&&(_r.quaternion.copy(Ze.quaternion),ec.copy(Ze.position).sub(De.target),Ro.uniforms.uElevation.value=Math.abs(ec.y)/Math.max(ec.length(),1e-4)),H_(),ct("time-value").textContent=k_(),Ni.render(Hn,Ze)}function G_(i){let t=vr.getBoundingClientRect();tc.x=(i.clientX-t.left)/t.width*2-1,tc.y=-(i.clientY-t.top)/t.height*2+1,vu.setFromCamera(tc,Ze);let e=r=>{let a=r;for(;a;){if(!a.visible)return!1;a=a.parent}return!0},n=vu.intersectObjects(Es.filter(r=>r.parent&&e(r)),!0);if(!n.length)return;let s=n[0].object;for(;s&&!s.userData.id;)s=s.parent;s?.userData.id&&Fi(s.userData.id)}var fr=null;vr.addEventListener("pointerdown",i=>fr={x:i.clientX,y:i.clientY});vr.addEventListener("pointerup",i=>{fr&&Math.hypot(i.clientX-fr.x,i.clientY-fr.y)<6&&G_(i),fr=null});document.addEventListener("click",i=>{let t=i.target.closest("[data-target]");t&&(Fi(t.dataset.target),ct("search-input").value="",ct("search-results").hidden=!0,ct("catalog-panel").classList.remove("open")),i.target.closest("[data-nav]")?.dataset.nav==="galaxy"&&Fi("galaxy")});ct("search-input").addEventListener("input",i=>z_(i.target.value));ct("search-input").addEventListener("keydown",i=>{if(i.key==="Enter"){let t=ct("search-results").querySelector("[data-target]");t&&Fi(t.dataset.target),i.target.value="",ct("search-results").hidden=!0}else i.key==="Escape"&&(ct("search-results").hidden=!0,i.target.blur())});document.addEventListener("keydown",i=>{i.key==="/"&&!/input|textarea/i.test(document.activeElement.tagName)&&(i.preventDefault(),ct("search-input").focus()),i.key==="Escape"&&document.activeElement!==ct("search-input")&&(le==="earth"||le==="blackhole"||le==="system")&&Fi(le==="earth"?"solar-system":"galaxy")});document.querySelectorAll(".catalog-tabs button").forEach(i=>i.addEventListener("click",()=>{document.querySelectorAll(".catalog-tabs button").forEach(t=>t.classList.toggle("active",t===i)),fc(i.dataset.catalog)}));ct("play-button").addEventListener("click",()=>{kn=!kn,ct("play-button").querySelector("span").textContent=kn?"\u2161":"\u25B6",ct("play-button").querySelector("small").textContent=kn?"\u6682\u505C":"\u64AD\u653E"});ct("speed-button").addEventListener("click",()=>{xr=(xr+1)%yr[le].length,Tu()});ct("orbit-button").addEventListener("click",()=>{dr=!dr,ct("orbit-button").classList.toggle("active",dr);for(let i of Ts.values())i.orbit&&(i.orbit.visible=dr);$e.earth?.userData.moonOrbit&&($e.earth.userData.moonOrbit.visible=dr)});ct("label-button").addEventListener("click",()=>{document.body.classList.toggle("no-labels"),ct("label-button").classList.toggle("active",!document.body.classList.contains("no-labels"))});ct("quality-button").addEventListener("click",()=>{oi=oi==="auto"?"high":oi==="high"?"low":"auto",cc()});ct("home-button").addEventListener("click",()=>Fi("galaxy"));ct("panel-close").addEventListener("click",()=>{ct("info-panel").classList.add("collapsed"),ct("info-reopen").hidden=!1});ct("info-reopen").addEventListener("click",()=>{ct("info-panel").classList.remove("collapsed"),ct("info-reopen").hidden=!0});ct("mobile-catalog").addEventListener("click",()=>ct("catalog-panel").classList.toggle("open"));ct("model-info").addEventListener("click",()=>ct("model-dialog").showModal());ct("dialog-close").addEventListener("click",()=>ct("model-dialog").close());addEventListener("resize",()=>{Ze.aspect=innerWidth/innerHeight,Ze.updateProjectionMatrix(),cc()});async function W_(){Li(8),M_(),Li(18,"\u6B63\u5728\u751F\u6210\u94F6\u6CB3\u65CB\u81C2","DISTRIBUTING STARS AND DUST"),S_(),Li(28,"\u6B63\u5728\u8BFB\u53D6\u5929\u4F53\u8D44\u6599","NASA / JPL / USGS DATA"),await A_(),Li(82,"\u6B63\u5728\u5EFA\u7ACB\u5730\u6708\u7CFB\u7EDF","LOADING EARTH\u2013MOON SYSTEM"),await R_(),C_(),Li(94,"\u6B63\u5728\u6821\u51C6\u76F8\u673A","CALIBRATING OBSERVATION SCALES"),dc(),Eu(),fc(),Di("galaxy","galaxy",!0),Co("galaxy"),Ui&&(ct("info-panel").classList.add("collapsed"),ct("info-reopen").hidden=!1),Li(100,"\u94F6\u6CB3\u5750\u6807\u7CFB\u5DF2\u5C31\u7EEA","MODEL READY"),setTimeout(()=>{ct("loading").classList.add("done"),window.__galaxyReady=!0},450);let i=location.hash.slice(1);i&&Oe[i]&&i!=="galaxy"&&setTimeout(()=>Fi(i),900),requestAnimationFrame(wu)}W_().catch(i=>{console.error(i),window.__showGalaxyError(i?.message||"MODEL INITIALIZATION ERROR")});})();
